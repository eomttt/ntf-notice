  ...
  <Layout>
    ...
    <div className="flex flex-col items-center justify-center">
      <div className="flex items-center justify-center">
        <div className="flex h-10 w-20 mt-24 items-center justify-center">이메일</div>
      ...
      <div className="flex items-center justify-center">
        <div className="flex h-10 w-20 mt-4 items-center justify-center">비밀번호</div>
        <div className="border-2 border-gray-300 h-10 w-64 p-2 mt-4 flex items-center rounded-md">
          <input
            type="email"
            name="email"
            placeholder="4자리 입력(설정한 경우)"
            className="placeholder:text-gray-500 outline-none text-md flex-1"
          />
        </div>
      </div>
